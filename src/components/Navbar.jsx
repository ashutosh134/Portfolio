    ...
    <>
      ...
      <nav className=" hidden px-6 z-[100] py-10 bg-neutral-100 lg:w-[15%] border-r border-neutral-200/[0.8] fixed top-0 h-screen lg:relative  left-0 lg:flex flex-col justify-between max-w-[14rem]">
        <div className="flex items-center">
          <img
            className="rounded-3xl w-10 object-cover object-left h-10"
            src="/profile.jpeg"
            alt=""
          />
        ...
        <div className="flex flex-col space-y-1 my-10 relative z-[100]">
          ...
          <a
            ...
            href="https://github.com/ashutosh134"
          >
            <svg
          ...
          <a
            ...
            className="text-secondary hover:text-sky-500 transition duration-200 flex items-center space-x-2 py-2 px-2 rounded-md text-sm"
            href="https://api.whatsapp.com/send?phone=8435218672&text=Hello%20there!"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
